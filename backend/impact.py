"""
Impact comparisons: convert energy and CO2 into relatable equivalents.

Sources:
  - EPA GHG Equivalencies Calculator (2024)
  - IEA global grid average: 475 gCO2/kWh
  - Smartphone charge: ~12.4g CO2
  - Car driving: 404g CO2/mile (EPA 2024)
  - LED bulb: 10W
  - Google search: ~0.3g CO2 (Also EPA 2024 (iirc)) # TODO: verify source (for all in general)
  - Streaming video: ~36g CO2/hour estimates
"""
...
def compute_impact(energy_kwh: float, carbon_grams: float) -> dict:
    ...
    if car_km >= 0.01:
        comparisons.append({
            ...
            "unit": "km driven",
            "text": f"Same CO2 as driving a car {_fmt(car_km)} km",
        })
